...
public class AutomateClientTest {
    ...
    @Before
    public void setup() {
        System.setProperty("browserstack.automate.api", "https://wtf2.bsstag.com/automate");
        username = "shirishk1"; // System.getenv("BROWSERSTACK_USER");
        key = "KpmrspfwvxaoWrFGbz7J"; //System.getenv("BROWSERSTACK_ACCESSKEY");
    ...
    @Test
    public void testGetSession() throws JsonProcessingException {
        try {
...
//            ObjectMapper mapper = new ObjectMapper();
            ...
            System.out.println("/builds/sessions: " + session1.getPublicUrl());
            System.out.println("/sessions: " + session2.getPublicUrl());
        } catch (BuildNotFound e) {
            assertTrue(false);
